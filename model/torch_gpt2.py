...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        return outputs, hidden_states  # (loss), lm_logits, presents, (all hidden_states), (attentions)
...
class GPT2DoubleHeadsModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        return outputs, hidden_states  # (lm loss), (mc loss), lm logits, mc logits, presents, (all hidden_states), (attentions)
